...
export const config = {
    ...
    //  - share/, api/share/ Share Link: Seite und Bring-HTML für den Share Recipient;
    //                       der Share Token ist dort das Gate, nicht die Session
    //  - login           Login-Seite
    //  - Next-Assets & statische Public-Dateien (Bilder etc.)
    matcher: [
        '/((?!api/auth|api/images|api/recipes/bring|share/|api/share/|login|_next/static|_next/image|favicon.ico|.*\\.(?:png|jpg|jpeg|gif|svg|ico|webp)$).*)',
    ],
};
